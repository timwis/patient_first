...
#
#     PHX_SERVER=true bin/patient_first start
#
...
if config_env() == :prod do
  ...
  config :patient_first, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :patient_first, PatientFirst.Mailer,
